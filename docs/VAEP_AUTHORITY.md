...
- El catálogo de autorefill contiene únicamente trabajo material, scope exclusivo y no busywork. Mientras exista backlog elegible, los checkpoints deben mantener un colchón de al menos 20 entradas UNUSED por lane; si baja de 20, reponer catálogo desde CURRENT/NEXT parent antes de trabajo largo. Si llega a 8 o menos, es EMERGENCY_BACKLOG_DEBT y el checkpoint debe priorizar refill de catálogo por encima de review/CI no causal. Nunca esperar a cero ni inventar APIs, producción o evidencia.
