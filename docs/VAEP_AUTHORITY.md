...
- El catálogo de autorefill contiene únicamente trabajo material, scope exclusivo y no busywork. Mientras exista backlog elegible, los checkpoints deben mantener un colchón de al menos 6 entradas UNUSED por lane; si baja de ese piso, reponer catálogo desde CURRENT/NEXT parent sin inventar APIs, producción ni evidencia.
