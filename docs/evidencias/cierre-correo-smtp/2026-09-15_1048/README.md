...
| 04 Facturación DEV/UAT | PASS | `04_variapp_facturacion_dev.png` | Factura y venta de DEV/UAT visibles. |
...
| 10 Historial VariApp | PASS | `10_historial_envio_variapp.png` | Un registro por Correo con resultado Enviado. |
