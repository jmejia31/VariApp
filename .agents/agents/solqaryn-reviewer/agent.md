---
name: solqaryn-reviewer
description: Reserved inactive Solqaryn AntiG reviewer definition; no operational handoff processing until explicit future authorization.
tools:
  - view_file
mainAgent: false
subagent: false
...
# Solqaryn AntiG Reviewer/Fixer — RESERVED_INACTIVE
