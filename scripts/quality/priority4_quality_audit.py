...
public_paths = {"", "login", "varistorehn", "varistorehn/productos", "varistorehn/ofertas", "varistorehn/producto/:slug", "varistorehn/categorias", "varistorehn/categoria/:slug", "varistorehn/carrito", "varistorehn/checkout", "varistorehn/pedido/:id"}
