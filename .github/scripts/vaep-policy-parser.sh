...
readonly ALLOWED_KEYS=(
  ...
  "JULES_TASKS_TARGET_ROLLING_24H_PER_WORKER"
  "JULES_TASKS_TARGET_ROLLING_24H_TOTAL"
  "JULES_REFILL_MAX_GAP_MINUTES"
  ...
  "JULES_PROGRAMMED_BACKLOG_TARGET_PER_WORKER"
  "JULES_PROGRAMMED_BACKLOG_REFILL_FLOOR_PER_WORKER"
  "JULES_PROGRAMMED_BACKLOG_TARGET_TOTAL"
  "JULES_DISPATCH_ELIGIBLE_MIN_PER_WORKER"
...
is_string_key() {
  case "$1" in
    VAEP_CHECKPOINTS|VAEP_SUPERVISOR_CHECKPOINTS|VAEP_ALL_ACTIVE_SLOTS|GLOBAL_DISPATCH_ADMISSION|CAUSAL_HOLD_SCOPE) return 0 ;;
    *) return 1 ;;
  esac
}
...
parse_policy_block() {
  ...
  while IFS= read -r raw_line || [[ -n "$raw_line" ]]; do
    ...
    case "$key" in
      PARENT_CLOSE_SLA_ROLLING_60M|PARENT_CLOSE_SLA_ROLLING_24H|JULES_TASKS_TARGET_ROLLING_24H_PER_WORKER|JULES_TASKS_TARGET_ROLLING_24H_TOTAL|JULES_REFILL_MAX_GAP_MINUTES|PARENT_MAX_DWELL_MINUTES|PARENT_STALL_NO_PROGRESS_MINUTES|CLOSURE_REVIEW_MAX_LATENCY_MINUTES|CLOSURE_DEBT_TRIGGER_LT|JULES_QUEUE_DEPTH_TARGET|JULES_PROGRAMMED_BACKLOG_TARGET_PER_WORKER|JULES_PROGRAMMED_BACKLOG_REFILL_FLOOR_PER_WORKER|JULES_PROGRAMMED_BACKLOG_TARGET_TOTAL|JULES_DISPATCH_ELIGIBLE_MIN_PER_WORKER|LANE_REFILL_DEADLINE_SECONDS|JULES_LANE_BUDGET_SECONDS|JULES_MAX_ATTEMPTS)
