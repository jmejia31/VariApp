...
readonly ALLOWED_KEYS=(
  ...
  MANUAL_RUN_OFF_SLOT_PROHIBITED MANUAL_RUN_SELECTION_TIEBREAK
  DEFECT_RECOVERY_FIRST FIRST_DETECTOR_OWNS_RECOVERY
  ...
  OWNER_INTERVENTION_REPLAY_START OWNER_INTERVENTION_RESUME_FROM
  OWNER_INTERVENTION_BYPASS_PROHIBITED
  POST_INTERVENTION_REVALIDATION_REQUIRED POST_INTERVENTION_REVALIDATION_START_ROW
  POST_INTERVENTION_REVALIDATION_END_ROW POST_INTERVENTION_REVALIDATE_EXISTING_LISTO
  POST_INTERVENTION_REVALIDATION_BASIS POST_INTERVENTION_REOPEN_ON_GAP
  POST_INTERVENTION_HISTORICAL_STATUS_PRESERVED
  POST_INTERVENTION_REVALIDATION_ADMISSION POST_INTERVENTION_REVALIDATION_STATE
  POST_INTERVENTION_BULK_REOPEN_PROHIBITED OWNER_BULK_REOPEN_701_881_EXECUTED
  PRODUCTION_RELEASE_EXCEPTION_EXECUTED PRODUCTION_RELEASE_PR
  PRODUCTION_RELEASE_PR_STATE PRODUCTION_RELEASE_MAIN_BASELINE
  PR2_REOPEN_REQUIRED FUTURE_MAIN_CHANGES_REQUIRE_FRESH_OWNER_AUTH
  FUTURE_PRODUCTION_CHANGES_REQUIRE_FRESH_OWNER_AUTH
)
