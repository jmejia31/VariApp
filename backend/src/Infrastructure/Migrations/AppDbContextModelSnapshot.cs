...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.Contabilidad.ConfiguracionContable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CuentaDebeId");

                    b.HasIndex("CuentaHaberId");

                    b.HasIndex("Evento")
                        .IsUnique()
                        .HasDatabaseName("UX_ConfiguracionesContables_Evento");

                    b.ToTable("ConfiguracionesContables", (string)null);
                });

            modelBuilder.Entity("InventoryApp.Domain.Entities.Contabilidad.PeriodoContable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PeriodosContables", null, t =>
                        {
                            t.HasCheckConstraint("CK_PeriodosContables_Cierre", "(`Estado` = 1 AND `CerradoEnUtc` IS NULL) OR (`Estado` = 2 AND `CerradoEnUtc` IS NOT NULL)");

                            t.HasCheckConstraint("CK_PeriodosContables_Estado", "`Estado` IN (1, 2)");

                            t.HasCheckConstraint("CK_PeriodosContables_Rango", "`FechaFin` >= `FechaInicio`");
                        });
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.DashboardKpiConfiguracion", b =>
                {
                    ...
                    b.ToTable("DashboardKpiConfiguraciones", null, t =>
                        {
                            t.HasCheckConstraint("CK_DashboardKpiConfiguraciones_Owner", "(`UsuarioId` IS NOT NULL AND `RolId` IS NULL) OR (`UsuarioId` IS NULL AND `RolId` IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.DocumentoFiscalEmision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ClaveIdempotenciaHash")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
                    ...
                    b.HasIndex("EmpresaId", "FacturaId", "CreadoUtc")
                        .HasDatabaseName("IX_DocFiscal_Empresa_Factura_Creado");

                    b.HasIndex("EmpresaId", "Proveedor", "ClaveIdempotenciaHash")
                        .IsUnique()
                        .HasDatabaseName("UX_DocFiscal_Empresa_Proveedor_Idempotencia");

                    b.HasIndex("EmpresaId", "Proveedor", "ReferenciaExterna")
                        .IsUnique()
                        .HasDatabaseName("UX_DocFiscal_Empresa_Proveedor_Referencia");

                    b.HasIndex("EmpresaId", "Estado", "UltimaActualizacionUtc", "Id")
                        .HasDatabaseName("IX_DocFiscal_Empresa_Estado_Actualizado");

                    b.ToTable("DocumentosFiscalesEmision", null, t =>
                        {
                            t.HasCheckConstraint("CK_DocFiscal_EmpresaId_Positivo", "`EmpresaId` > 0");

                            t.HasCheckConstraint("CK_DocFiscal_Estado_Valido", "`Estado` BETWEEN 1 AND 3");

                            t.HasCheckConstraint("CK_DocFiscal_FacturaId_Positivo", "`FacturaId` > 0");

                            t.HasCheckConstraint("CK_DocFiscal_HashSnapshot_NoVacio", "CHAR_LENGTH(TRIM(`HashSnapshot`)) > 0");

                            t.HasCheckConstraint("CK_DocFiscal_IdempotenciaHash_SHA256", "CHAR_LENGTH(`ClaveIdempotenciaHash`) = 64");

                            t.HasCheckConstraint("CK_DocFiscal_Jurisdiccion_NoVacia", "CHAR_LENGTH(TRIM(`Jurisdiccion`)) > 0");

                            t.HasCheckConstraint("CK_DocFiscal_Proveedor_NoVacio", "CHAR_LENGTH(TRIM(`Proveedor`)) > 0");

                            t.HasCheckConstraint("CK_DocFiscal_SucursalId_Positivo", "`SucursalId` IS NULL OR `SucursalId` > 0");

                            t.HasCheckConstraint("CK_DocFiscal_TipoDocumento_NoVacio", "CHAR_LENGTH(TRIM(`TipoDocumento`)) > 0");
                        });
                });

            modelBuilder.Entity("InventoryApp.Domain.Entities.EmailEmpresarial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("AceptadoProveedorEnUtc")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<string>("CodigoRebote")
                        .HasMaxLength(160)
                        .HasColumnType("varchar(160)");
                    ...
                    b.Property<DateTime?>("RebotadoEnUtc")
                        .HasColumnType("datetime(6)");

                    b.Property<int?>("TipoRebote")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmpresaId", "MensajeId")
                        .IsUnique()
                        .HasDatabaseName("UX_EmailsEmpresariales_Empresa_MensajeId");

                    b.HasIndex("EmpresaId", "ProviderMessageId")
                        .IsUnique()
                    ...
                    b.ToTable("EmailsEmpresariales", null, t =>
                        {
                            t.HasCheckConstraint("CK_EmailsEmpresariales_ClaveIdempotencia_NoVacia", "CHAR_LENGTH(TRIM(`ClaveIdempotencia`)) > 0");

                            t.HasCheckConstraint("CK_EmailsEmpresariales_Contenido_O_Plantilla", "((`PlantillaCodigo` IS NULL AND `PlantillaVersion` IS NULL AND `VariablesJson` IS NULL AND `Asunto` IS NOT NULL AND `CuerpoHtml` IS NOT NULL) OR (`PlantillaCodigo` IS NOT NULL AND `PlantillaVersion` IS NOT NULL AND `PlantillaVersion` > 0 AND `VariablesJson` IS NOT NULL AND `Asunto` IS NULL AND `CuerpoHtml` IS NULL AND `CuerpoTexto` IS NULL))");

                            t.HasCheckConstraint("CK_EmailsEmpresariales_Destinatario_NoVacio", "CHAR_LENGTH(TRIM(`Destinatario`)) > 0");

                            t.HasCheckConstraint("CK_EmailsEmpresariales_EmpresaId_Positivo", "`EmpresaId` > 0");

                            t.HasCheckConstraint("CK_EmailsEmpresariales_Estado_Valido", "`Estado` BETWEEN 0 AND 6");

                            t.HasCheckConstraint("CK_EmailsEmpresariales_Intentos_NoNegativo", "`Intentos` >= 0");
                        });
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.Empresa", b =>
                {
                    ...
                    b.HasIndex("Activa", "Nombre")
                        .HasDatabaseName("IX_Empresas_Activa_Nombre");

                    b.ToTable("Empresas", null, t =>
                        {
                            t.HasCheckConstraint("CK_Empresas_Nombre_NoVacio", "CHAR_LENGTH(TRIM(`Nombre`)) > 0");
                        });
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.PagoOnline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ConfirmadoUtc")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("EmpresaId", "Proveedor", "ProviderEventId")
                        .IsUnique()
                        .HasDatabaseName("UX_PagosOnline_Empresa_Proveedor_Evento");

                    b.HasIndex("EmpresaId", "Proveedor", "ReferenciaProveedor")
                        .IsUnique()
                        .HasDatabaseName("UX_PagosOnline_Empresa_Proveedor_Referencia");

                    b.HasIndex("EmpresaId", "Estado", "CreadoUtc", "Id")
                        .HasDatabaseName("IX_PagosOnline_Empresa_Estado_Creado");

                    b.ToTable("PagosOnline", null, t =>
                        {
                            t.HasCheckConstraint("CK_PagosOnline_EmpresaId_Positivo", "`EmpresaId` > 0");

                            t.HasCheckConstraint("CK_PagosOnline_Estado_Valido", "`Estado` BETWEEN 1 AND 3");

                            t.HasCheckConstraint("CK_PagosOnline_FacturaId_Positivo", "`FacturaId` > 0");

                            t.HasCheckConstraint("CK_PagosOnline_Moneda_Valida", "CHAR_LENGTH(TRIM(`Moneda`)) = 3");

                            t.HasCheckConstraint("CK_PagosOnline_Monto_Positivo", "`Monto` > 0");

                            t.HasCheckConstraint("CK_PagosOnline_Proveedor_NoVacio", "CHAR_LENGTH(TRIM(`Proveedor`)) > 0");
                        });
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.PlantillaEmailEmpresarial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AsuntoPlantilla")
                        .IsRequired()
                        .HasMaxLength(998)
                        .HasColumnType("varchar(998)");
                    ...
                    b.Property<string>("CuerpoHtmlPlantilla")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<string>("CuerpoTextoPlantilla")
                        .HasColumnType("longtext");
                    ...
                    b.HasIndex("EmpresaId", "Codigo", "Activa")
                        .HasDatabaseName("IX_PlantillasEmail_Empresa_Codigo_Activa");

                    b.HasIndex("EmpresaId", "Codigo", "Version")
                        .IsUnique()
                        .HasDatabaseName("UX_PlantillasEmail_Empresa_Codigo_Version");

                    b.ToTable("PlantillasEmailEmpresarial", null, t =>
                        {
                            t.HasCheckConstraint("CK_PlantillasEmail_Asunto_NoVacio", "CHAR_LENGTH(TRIM(`AsuntoPlantilla`)) > 0");

                            t.HasCheckConstraint("CK_PlantillasEmail_Codigo_NoVacio", "CHAR_LENGTH(TRIM(`Codigo`)) > 0");

                            t.HasCheckConstraint("CK_PlantillasEmail_EmpresaId_Positivo", "`EmpresaId` > 0");

                            t.HasCheckConstraint("CK_PlantillasEmail_Html_NoVacio", "CHAR_LENGTH(TRIM(`CuerpoHtmlPlantilla`)) > 0");

                            t.HasCheckConstraint("CK_PlantillasEmail_Nombre_NoVacio", "CHAR_LENGTH(TRIM(`Nombre`)) > 0");

                            t.HasCheckConstraint("CK_PlantillasEmail_Version_Positiva", "`Version` > 0");
                        });
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.SecuenciaDocumento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SucursalScopeKey")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("int")
                        .HasComputedColumnSql("IFNULL(`SucursalId`, 0)", true);
                    ...
                    b.HasIndex("EmpresaId", "SucursalScopeKey", "TipoDocumento")
                        .IsUnique()
                        .HasDatabaseName("UX_SecuenciasDocumento_Empresa_Sucursal_Tipo");

                    b.ToTable("SecuenciasDocumento", (string)null);
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.WebhookEntrante", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("RechazadoEnUtc")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("EmpresaId", "Proveedor", "EventoExternoId")
                        .IsUnique()
                        .HasDatabaseName("UX_WebhooksEntrantes_Empresa_Proveedor_Evento");

                    b.HasIndex("EmpresaId", "Estado", "RecibidoEnUtc", "Id")
                        .HasDatabaseName("IX_WebhooksEntrantes_Empresa_Estado_Recibido");

                    b.ToTable("WebhooksEntrantes", null, t =>
                        {
                            t.HasCheckConstraint("CK_WebhooksEntrantes_EmpresaId_Positivo", "`EmpresaId` > 0");

                            t.HasCheckConstraint("CK_WebhooksEntrantes_Estado_Valido", "`Estado` BETWEEN 1 AND 4");

                            t.HasCheckConstraint("CK_WebhooksEntrantes_EventoExternoId_NoVacio", "CHAR_LENGTH(TRIM(`EventoExternoId`)) > 0");

                            t.HasCheckConstraint("CK_WebhooksEntrantes_PayloadHash_NoVacio", "CHAR_LENGTH(TRIM(`PayloadHash`)) > 0");

                            t.HasCheckConstraint("CK_WebhooksEntrantes_Proveedor_NoVacio", "CHAR_LENGTH(TRIM(`Proveedor`)) > 0");

                            t.HasCheckConstraint("CK_WebhooksEntrantes_TipoEvento_NoVacio", "CHAR_LENGTH(TRIM(`TipoEvento`)) > 0");
                        });
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.Contabilidad.ConfiguracionContable", b =>
                {
                    b.HasOne("InventoryApp.Domain.Entities.CuentaContable", "CuentaDebe")
                        .WithMany()
                        .HasForeignKey("CuentaDebeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InventoryApp.Domain.Entities.CuentaContable", "CuentaHaber")
                        .WithMany()
                        .HasForeignKey("CuentaHaberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CuentaDebe");

                    b.Navigation("CuentaHaber");
                });
            ...
            modelBuilder.Entity("InventoryApp.Domain.Entities.DocumentoFiscalEmision", b =>
                {
                    ...
                    b.HasOne("InventoryApp.Domain.Entities.Sucursal", null)
                        .WithMany()
                        .HasForeignKey("SucursalId")
                        .OnDelete(DeleteBehavior.Restrict);
