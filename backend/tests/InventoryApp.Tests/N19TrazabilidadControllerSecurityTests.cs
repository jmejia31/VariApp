...
public sealed class N19TrazabilidadControllerSecurityTests
{
    ...
    [InlineData(nameof(TrazabilidadInventarioController.GetLoteById), AccionPermiso.Ver)]
    ...
    [InlineData(nameof(TrazabilidadInventarioController.GetSerieById), AccionPermiso.Ver)]
