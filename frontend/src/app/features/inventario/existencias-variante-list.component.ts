          ...
          <table>
            ...
            <tbody>
              <tr *ngFor="let item of existencias(); trackBy: trackById">
                ...
                <td *ngIf="puedeEditar()" data-label="Acciones"><button mat-button color="primary" type="button" (click)="editar(item)"><mat-icon>tune</mat-icon> Configurar</button></td>
              </tr>
            </tbody>
          </table>
