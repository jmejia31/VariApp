...
export class AppComponent implements OnDestroy {
  ...
  constructor(
    ...
    this.identidad.cargar().subscribe(() => {
      this.seo.aplicarRuta(this.router.url, this.identidad.config().nombreComercial || 'VariStoreHN');
    });
    ...
    this.router.events.subscribe((event) => {
      if (event instanceof NavigationEnd) {
        this.seo.aplicarRuta(event.urlAfterRedirects, this.identidad.config().nombreComercial || 'VariStoreHN');
        this.cerrarSidebar();
