...
import { CuentaContable, CuentaContableInput } from '../core/models/cuenta-contable.model';
...
export class CuentaContableService {
  ...
  getRaices(): Observable<ApiResponse<CuentaContable[]>> {
    return this.http.get<ApiResponse<CuentaContable[]>>(`${this.apiUrl}/raices`);
  }
